...
public sealed class CheckLevelSkillCondition: ISkillCondition
{
    ...
    public override int GetHashCode() => HashCode.Combine(_minLevel, _maxLevel, _affectType);
    public override bool Equals(object? obj) => this.EqualsTo(obj, static x => (x._minLevel, x._maxLevel, x._affectType));
}