...
public sealed class OpPkcountSkillCondition: ISkillCondition
{
    ...
    public override int GetHashCode() => HashCode.Combine(_affectType);
    public override bool Equals(object? obj) => this.EqualsTo(obj, static x => x._affectType);
}