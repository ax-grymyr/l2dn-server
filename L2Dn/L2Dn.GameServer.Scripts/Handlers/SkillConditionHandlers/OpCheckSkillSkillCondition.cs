...
public sealed class OpCheckSkillSkillCondition: ISkillCondition
{
    ...
    public override int GetHashCode() => HashCode.Combine(_skillId, _affectType);
    public override bool Equals(object? obj) => this.EqualsTo(obj, static x => (x._skillId, x._affectType));
}