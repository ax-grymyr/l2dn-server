...
public sealed class TargetRaceSkillCondition: ISkillCondition
{
    ...
    public override int GetHashCode() => HashCode.Combine(_races);
    public override bool Equals(object? obj) => this.EqualsTo(obj, static x => x._races);
}