...
public sealed class OpEncumberedSkillCondition: ISkillCondition
{
    ...
    public override int GetHashCode() => HashCode.Combine(_slotsPercent, _weightPercent);
    public override bool Equals(object? obj) => this.EqualsTo(obj, static x => (x._slotsPercent, x._weightPercent));
}