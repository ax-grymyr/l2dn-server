...
public static class Scripts
{
    public static void RegisterHandlers()
    {
		...
		effectHandler.registerHandler("DefencePhysicalSkillCriticalDamage", stat => new DefencePhysicalSkillCriticalDamage(stat));
		effectHandler.registerHandler("DefencePhysicalSkillCriticalRate", stat => new DefencePhysicalSkillCriticalRate(stat));
		...
		effectHandler.registerHandler("MagicCriticalRateByCriticalRate", stat => new MagicCriticalRateByCriticalRate(stat));
		...
		effectHandler.registerHandler("PveRaidMagicalSkillDamageBonus", stat => new PveRaidMagicalSkillDamageBonus(stat));
		effectHandler.registerHandler("PveRaidMagicalSkillDefenceBonus", stat => new PveRaidMagicalSkillDefenceBonus(stat));
		effectHandler.registerHandler("PveRaidPhysicalAttackDamageBonus", stat => new PveRaidPhysicalAttackDamageBonus(stat));
		effectHandler.registerHandler("PveRaidPhysicalAttackDefenceBonus", stat => new PveRaidPhysicalAttackDefenceBonus(stat));
		effectHandler.registerHandler("PveRaidPhysicalSkillDamageBonus", stat => new PveRaidPhysicalSkillDamageBonus(stat));
		effectHandler.registerHandler("PveRaidPhysicalSkillDefenceBonus", stat => new PveRaidPhysicalSkillDefenceBonus(stat));
		...
		skillConditionHandler.registerHandler("CanAddMaxEntranceInzone", stat => new CanAddMaxEntranceInzoneSkillCondition(stat));
		skillConditionHandler.registerHandler("CanBookmarkAddSlot", stat => new CanBookmarkAddSlotSkillCondition(stat));
		skillConditionHandler.registerHandler("CanChangeVitalItemCount", stat => new CanChangeVitalItemCountSkillCondition(stat));
		skillConditionHandler.registerHandler("CanEnchantAttribute", stat => new CanEnchantAttributeSkillCondition(stat));
		skillConditionHandler.registerHandler("CanMountForEvent", stat => new CanMountForEventSkillCondition(stat));
		skillConditionHandler.registerHandler("CannotUseInTransform", stat => new CannotUseInTransformSkillCondition(stat));
		...
		skillConditionHandler.registerHandler("CanSummonSiegeGolem", stat => new CanSummonSiegeGolemSkillCondition(stat));
		...
		skillConditionHandler.registerHandler("CanTransformInDominion", stat => new CanTransformInDominionSkillCondition(stat));
		skillConditionHandler.registerHandler("CanUntransform", stat => new CanUntransformSkillCondition(stat));
		skillConditionHandler.registerHandler("CanUseInBattlefield", stat => new CanUseInBattlefieldSkillCondition(stat));
		...
		skillConditionHandler.registerHandler("CanUseVitalityIncreaseItem", stat => new CanUseVitalityIncreaseItemSkillCondition(stat));
		...
		skillConditionHandler.registerHandler("EquippedCloakEnchant", stat => new EquippedCloakEnchantSkillCondition(stat));
		...
		skillConditionHandler.registerHandler("OpCannotUseTargetWithPrivateStore", stat => new OpCannotUseTargetWithPrivateStoreSkillCondition(stat));
		...
		skillConditionHandler.registerHandler("OpCheckOnGoingEventCampaign", stat => new OpCheckOnGoingEventCampaignSkillCondition(stat));
		...
		skillConditionHandler.registerHandler("OpNotAffectedBySkill", stat => new OpNotAffectedBySkillSkillCondition(stat));
		...
		skillConditionHandler.registerHandler("OpTargetAllItemType", stat => new OpTargetAllItemTypeSkillCondition(stat));
		...
		skillConditionHandler.registerHandler("OpTargetMyPledgeAcademy", stat => new OpTargetMyPledgeAcademySkillCondition(stat));
		...
		skillConditionHandler.registerHandler("OpTargetWeaponAttackType", stat => new OpTargetWeaponAttackTypeSkillCondition(stat));
		...
		skillConditionHandler.registerHandler("TargetAffectedBySkill", stat => new TargetAffectedBySkillSkillCondition(stat));
		skillConditionHandler.registerHandler("TargetItemCrystalType", stat => new TargetItemCrystalTypeSkillCondition(stat));
