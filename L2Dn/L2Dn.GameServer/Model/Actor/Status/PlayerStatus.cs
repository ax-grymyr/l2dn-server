...
public class PlayerStatus : PlayableStatus
{
	...
	public PlayerStatus(Player player): base(player)
	{
	}
	...
	public void reduceHp(double value, Creature attacker, Skill skill, bool awake, bool isDOT, bool isHPConsumption, bool ignoreCP)
	{
		...
		if ((attacker != null) && (attacker != getActiveChar()))
		{
			...
			if ((fullValue > 0) && !isDOT)
			{
				...
				{
					String[] localisation = NpcNameLocalisationData.getInstance().getLocalisation(getActiveChar().getLang(), attacker.getId());
