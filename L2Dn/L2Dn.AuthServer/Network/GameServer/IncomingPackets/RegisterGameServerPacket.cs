...
internal struct RegisterGameServerPacket: IIncomingPacket<GameServerSession>
{
    ...
    public ValueTask ProcessAsync(Connection<GameServerSession> connection)
    {
        ...
        RegistrationResult result = GameServerManager.Instance.RegisterServer(serverInfo);
        connection.Session.ServerInfo = GameServerManager.Instance.GetServerInfo(_serverId);
