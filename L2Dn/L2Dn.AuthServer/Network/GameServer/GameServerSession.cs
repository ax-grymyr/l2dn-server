...
internal sealed class GameServerSession(RsaKeyPair rsaKeyPair, byte[] blowfishKey, OldBlowfishEngine blowfishEngine)
    : Session, ISession<GameServerSessionState>
{
    public GameServerSessionState State { get; set; } = GameServerSessionState.None;
