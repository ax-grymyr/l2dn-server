...
public class Config
{
	...
	public static Regex CHARNAME_TEMPLATE_PATTERN = new(".*", RegexOptions.Compiled | RegexOptions.NonBacktracking);
	public static Regex PET_NAME_TEMPLATE = new(".*", RegexOptions.Compiled | RegexOptions.NonBacktracking);
	public static Regex CLAN_NAME_TEMPLATE = new(".*", RegexOptions.Compiled | RegexOptions.NonBacktracking);
	public static int MAX_CHARACTERS_NUMBER_PER_ACCOUNT;
	public static string DATAPACK_ROOT_PATH = "./DataPack";
	public static string SCRIPT_ROOT_PATH = "./DataPack/scripts";
