...
{
    private readonly Map<int, PetLevelData> _levelStats = [];
    private readonly List<PetSkillLearn> _skills = [];
    ...
    public sealed class PetSkillLearn: SkillHolder
    {
