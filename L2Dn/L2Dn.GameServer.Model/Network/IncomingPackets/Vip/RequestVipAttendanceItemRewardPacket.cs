...
public struct RequestVipAttendanceItemRewardPacket: IIncomingPacket<GameSession>
{
    ...
    public ValueTask ProcessAsync(Connection connection, GameSession session)
    {
        ...
        ImmutableArray<ItemHolder> rewards = AttendanceRewardData.getInstance().getRewards();
        ...
        if (_day > 0 && _day <= rewards.Length)
        {
            ...
            // Send message.
            SystemMessagePacket msg = new(SystemMessageId.YOU_VE_RECEIVED_YOUR_VIP_ATTENDANCE_REWARD_FOR_DAY_S1);
