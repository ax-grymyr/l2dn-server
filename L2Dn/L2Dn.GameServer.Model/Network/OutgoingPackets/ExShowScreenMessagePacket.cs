...
public struct ExShowScreenMessagePacket: IOutgoingPacket
{
	...
	private readonly int _sysMessageId;
	...
	private readonly int _npcString;
	 ...
	 * @param params the String parameters
	 */
	public ExShowScreenMessagePacket(NpcStringId npcString, int position, int time, bool showEffect, params string[] parameters)
	{
		_type = 2;
		_sysMessageId = -1;
		_unk1 = 0x00;
	...
	public void WriteContent(PacketBitWriter writer)
	{
		...
		writer.WriteInt32(_type);
		writer.WriteInt32(_sysMessageId);
		writer.WriteInt32(_position);
		writer.WriteInt32(_unk1);
		writer.WriteInt32(_size);
		writer.WriteInt32(_unk2);
